    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 class="push-down-0">Preguntas generales</h3>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <h3>Contactanos</h3>
                    <p>No dude en contactar con nosotros para cualquier problema que pueda tener con nuestros servicio</p>
                    <div class="form-group">
                        <label>E-mail</label>
                        <input type="email" class="form-control" placeholder="mail@dominio.com">
                    </div>
                    <div class="form-group">
                        <label>Asunto</label>
                ...
                <div class="panel-footer">
                    ...
                    <button class="btn btn-success pull-right"><span class="fa fa-envelope-o"></span> Enviar</button>
                </div>
            </div>
